...
class ScrollBar extends React.Component {
    ...
    render(){
        ...
        let arrowLeftTopClasses = `scrollbar-arrow-topleft ${isDragging ? 'active' : ''} ${isVoriziontal ? ' icon-ArrowLeft horizontal' : ''} ${isVertical ? ' icon-ArrowLeft-copy vertical' : ''}`;
        let arrowRightBottomClasses = `scrollbar-arrow-bottomright ${isDragging ? 'active' : ''} ${isVoriziontal ? ' icon-ArrowRight horizontal' : ''} ${isVertical ? ' icon-ArrowRight-copy vertical' : ''}`;

        return (
            <Motion style={springifiedScrollStyles}>
                { style =>
                    <div className="scrollbar-zone" >
                    <div className={arrowLeftTopClasses} />
                    <div
                    ...
                    <div className={arrowRightBottomClasses} />
                    </div>
                }
            </Motion>
        );
